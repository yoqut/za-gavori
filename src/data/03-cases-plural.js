  ...
  lessons: [
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "quiz",
          q: "«Я ви́жу ___ студе́нтов.» (новый)",
          options: ["но́вые", "но́вых", "но́вым", "но́выми"],
          answer: 1,
          hint: "«Студенты» jonli → tushum kelishigida qaratqich shakli: но́вых.",
        },
        {
          t: "quiz",
          q: "«Я ви́жу ___ дома́.» (новый)",
          options: ["но́вые", "но́вых", "но́вым", "но́выми"],
          answer: 0,
          hint: "«Дома» jonsiz → bosh kelishik shakli: но́вые.",
        },
        {
          t: "quiz",
          q: "«Я говорю́ со ___ друзья́ми.» (свой старый)",
          options: ["свои́ ста́рые", "свои́х ста́рых", "свои́ми ста́рыми", "свои́м ста́рым"],
          answer: 2,
          hint: "«С кем?» → vosita kelishigi ko'plikda: -ими / -ыми.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Мы говори́м об ___ кни́гах.» (эти новые)",
          answer: ["этих новых", "э́тих но́вых"],
          hint: "Predlog kelishigi ko'plikda → -их / -ых.",
        },
        {
          t: "match",
          q: "Sifatning ko'plik shaklini kelishikka ulang",
          pairs: [
            ["Роди́тельный", "но́вых"],
            ["Да́тельный", "но́вым"],
            ["Твори́тельный", "но́выми"],
            ["Имени́тельный", "но́вые"],
          ],
        },
      ],
    },
