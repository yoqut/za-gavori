  ...
  lessons: [
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "table",
          caption: "Sifat va olmoshlar ko'plikda — jins umuman yo'q",
          head: ["Kelishik", "но́вый → но́вые", "мой → мои́", "э́тот → э́ти"],
          rows: [
            ["Имени́тельный", "но́в<b class='hl'>ые</b>", "мо<b class='hl'>и́</b>", "э́т<b class='hl'>и</b>"],
            ["Роди́тельный", "но́в<b class='hl'>ых</b>", "мо<b class='hl'>и́х</b>", "э́т<b class='hl'>их</b>"],
            ["Да́тельный", "но́в<b class='hl'>ым</b>", "мо<b class='hl'>и́м</b>", "э́т<b class='hl'>им</b>"],
            ["Вини́тельный", "но́в<b class='hl'>ые</b> / но́в<b class='hl'>ых</b>", "мо<b class='hl'>и́</b> / мо<b class='hl'>и́х</b>", "э́т<b class='hl'>и</b> / э́т<b class='hl'>их</b>"],
            ["Твори́тельный", "но́в<b class='hl'>ыми</b>", "мо<b class='hl'>и́ми</b>", "э́т<b class='hl'>ими</b>"],
            ["Предло́жный", "о но́в<b class='hl'>ых</b>", "о мо<b class='hl'>и́х</b>", "об э́т<b class='hl'>их</b>"],
          ],
        },
        {
          t: "callout",
          tone: "info",
          title: "Ko'plikda sifat — atigi to'rtta shakl",
          text: "<b>-ые</b> (bosh) · <b>-ых</b> (qaratqich va predlog) · <b>-ым</b> (jo'nalish) · <b>-ыми</b> (vosita).<br>Tushum kelishigi esa yana jonlilikka qaraydi: <i>Я ви́жу <b>но́вые</b> дома́</i> (jonsiz), lekin <i>Я ви́жу <b>но́вых</b> студе́нтов</i> (jonli).<br><br>Yumshoq varianti: <b>хоро́шие, хоро́ших, хоро́шим, хоро́шими</b> (г,к,х va ж,ч,ш,щ dan keyin <b>и</b>).",
        },
        {
          t: "examples",
          items: [
            { ru: "В на́шем университе́те у́чатся <b class='hl'>иностра́нные студе́нты</b>.", uz: "Universitetimizda chet ellik talabalar o'qiydi." },
            { ru: "Я ви́жу <b class='hl'>но́вых студе́нтов</b>. (jonli → -ых)", uz: "Men yangi talabalarni ko'ryapman." },
            { ru: "Я ви́жу <b class='hl'>но́вые дома́</b>. (jonsiz → -ые)", uz: "Men yangi uylarni ko'ryapman." },
            { ru: "Я говорю́ <b class='hl'>со свои́ми ста́рыми друзья́ми</b>.", uz: "Men eski do'stlarim bilan gaplashyapman." },
            { ru: "Мы говори́м <b class='hl'>об э́тих но́вых кни́гах</b>.", uz: "Biz shu yangi kitoblar haqida gaplashyapmiz." },
          ],
        },
        {
          t: "callout",
