  ...
  lessons: [
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "quiz",
          q: "«У меня́ три ___.» (книга)",
          options: ["кни́га", "кни́ги", "книг", "кни́гу"],
          answer: 1,
          hint: "3 → qaratqich BIRLIK. «Книга» ning qaratqich birligi — кни́ги.",
        },
        {
          t: "quiz",
          q: "«В ко́мнате пять ___.» (стол)",
          options: ["стол", "стола́", "столо́в", "столы́"],
          answer: 2,
          hint: "5 → qaratqich KO'PLIK: столо́в.",
        },
        {
          t: "quiz",
          q: "«___ кни́ги» — «ikki kitob»",
          options: ["два", "две", "двa", "дво́е"],
          answer: 1,
          hint: "«Книга» — ayol jinsi → «две».",
        },
        {
          t: "quiz",
          q: "«Мне два́дцать оди́н ___.»",
          options: ["год", "го́да", "лет", "го́ды"],
          answer: 0,
          hint: "21 — oxirgi raqam «1», demak «год».",
        },
        {
          t: "quiz",
          q: "«Ему́ трина́дцать ___.»",
          options: ["год", "го́да", "лет"],
          answer: 2,
          hint: "13 — «надцать» guruhi → «лет». 3 ga aldanmang.",
        },
        {
          t: "fill",
          q: "To'ldiring: «У меня́ два ___.» (брат)",
          answer: ["брата", "бра́та"],
          hint: "2 → qaratqich birlik.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Ей два́дцать два ___.» (год)",
          answer: ["года", "го́да"],
          hint: "22 — oxiri «2» → го́да.",
        },
        {
          t: "match",
          q: "Sonni to'g'ri shakl bilan ulang",
          pairs: [
            ["1 стол", "стол"],
            ["2 стол", "стола́"],
            ["5 стол", "столо́в"],
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "quiz",
          q: "«Уро́к начина́ется в во́семь ___.»",
          options: ["час", "часа́", "часо́в", "часы́"],
          answer: 2,
          hint: "8 → «5+» guruhi → часо́в.",
        },
        {
          t: "quiz",
          q: "«Я рабо́таю ___.» (в среду — chorshanbada)",
          options: ["в среда́", "в сре́ду", "в среде́", "на сре́ду"],
          answer: 1,
          hint: "Hafta kunlari — «в» + tushum kelishigi: -а → -у.",
        },
        {
          t: "quiz",
          q: "«Я роди́лся ___.» (в марте — martda)",
          options: ["в март", "в ма́рту", "в ма́рте", "на ма́рте"],
          answer: 2,
          hint: "Oylar — «в» + predlog kelishigi: -е.",
        },
        {
          t: "quiz",
          q: "«___ я за́втракаю.» (ertalab)",
          options: ["У́тро", "В у́тро", "У́тром", "На у́тре"],
          answer: 2,
          hint: "Kun qismlari predlogsiz, vosita kelishigida: у́тром.",
        },
        {
          t: "quiz",
          q: "Qaysi to'g'ri: «Дверь откры́та ___ вто́рник.»",
          options: ["в", "во", "на", "о"],
          answer: 1,
          hint: "«Вторник» — вт- ikki undosh bilan boshlanadi → «во».",
        },
        {
          t: "fill",
          q: "To'ldiring: «Сейча́с два ___.» (час)",
          answer: ["часа", "часа́"],
          hint: "2 → qaratqich birlik: часа́.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Ле́том жа́рко, а ___ хо́лодно.» (qishda)",
          answer: ["зимой", "зимо́й"],
          hint: "Fasl — vosita kelishigida, predlogsiz: зимо́й.",
        },
        {
          t: "match",
          q: "Vaqt ifodasini to'g'ri shaklga ulang",
          pairs: [
            ["hafta kuni", "в сре́ду (tushum k.)"],
            ["oy", "в ма́рте (predlog k.)"],
            ["fasl", "зимо́й (vosita k.)"],
            ["soat", "в де́сять часо́в"],
          ],
        },
      ],
    },
