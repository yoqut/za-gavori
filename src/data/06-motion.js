  ...
  lessons: [
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "quiz",
          q: "«Сейча́с я ___ в магази́н.» (hozir do'konga ketyapman, piyoda)",
          options: ["хожу́", "иду́", "е́ду", "е́зжу"],
          answer: 1,
          hint: "Hozir + bir yo'nalish + piyoda → идти́ → иду́.",
        },
        {
          t: "quiz",
          q: "«Ка́ждый день я ___ в университе́т на метро́.»",
          options: ["иду́", "е́ду", "хожу́", "е́зжу"],
          answer: 3,
          hint: "«Каждый день» → muntazam. «На метро» → transport. Demak е́здить → е́зжу.",
        },
        {
          t: "quiz",
          q: "«Вчера́ ___ дождь.»",
          options: ["ходи́л", "шёл", "е́хал", "е́здил"],
          answer: 1,
          hint: "Yomg'ir har doim «идти́»: шёл дождь.",
        },
        {
          t: "quiz",
          q: "«Вчера́ я ___ в кино́.» (kinoga bordim va qaytdim)",
          options: ["шёл", "ходи́л", "е́хал", "иду́"],
          answer: 1,
          hint: "«Bordim va qaytdim» → ходи́л (= «был в кино»).",
        },
        {
          t: "quiz",
          q: "«Когда́ я ___ на рабо́ту, я встре́тил дру́га.» (yo'lda edim)",
          options: ["ходи́л", "шёл", "е́здил", "хожу́"],
          answer: 1,
          hint: "Jarayon, yo'ldaman → шёл.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Ка́ждое ле́то мы ___ в Крым.» (е́здить)",
          answer: ["ездим", "е́здим"],
          hint: "«Мы» + е́здить = е́здим.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Я ___ пешко́м.» (идти́, hozir)",
          answer: ["иду", "иду́"],
          hint: "Я + идти́ = иду́.",
        },
        {
          t: "match",
          q: "Vaziyatni to'g'ri fe'lga ulang",
          pairs: [
            ["Сейча́с, пешко́м", "иду́"],
            ["Сейча́с, на маши́не", "е́ду"],
            ["Ка́ждый день, пешко́м", "хожу́"],
            ["Ка́ждый год, на самолёте", "е́зжу"],
          ],
        },
      ],
    },
    ...
    /* ---------------------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        {
          t: "quiz",
          q: "«Он ___ в ко́мнату.» (xonaga kirdi)",
          options: ["вы́шел", "вошёл", "пришёл", "ушёл"],
          answer: 1,
          hint: "Kirmoq — «в-» prefiksi: войти́ → вошёл.",
        },
        {
          t: "quiz",
          q: "«Он ___ из ко́мнаты.» (xonadan chiqdi)",
          options: ["вошёл", "вы́шел", "подошёл", "перешёл"],
          answer: 1,
          hint: "Chiqmoq — «вы-» prefiksi + «из»: вы́йти → вы́шел.",
        },
        {
          t: "quiz",
          q: "«— Где Ива́н? — Он ___ в магази́н.» (ketdi, hali qaytmagan)",
          options: ["ходи́л", "пошёл", "шёл", "приходи́л"],
          answer: 1,
          hint: "«Пошёл» — ketdi va hali u yerda.",
        },
        {
          t: "quiz",
          q: "Qaysi predlog: «Он подошёл ___ окну́.»",
          options: ["в", "к", "от", "до"],
          answer: 1,
          hint: "«Под-» prefiksi «к» predlogini talab qiladi (yaqinlashish).",
        },
        {
          t: "quiz",
          q: "«Я ___ домо́й в шесть часо́в ка́ждый день.»",
          options: ["пришёл", "прихожу́", "приду́", "пришла́"],
          answer: 1,
          hint: "«Каждый день» → takrorlanish → НСВ hozirgi zamon: прихожу́.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Он ___ из Ташке́нта.» (прие́хать, o'tgan zamon, erkak)",
          answer: ["приехал", "прие́хал"],
          hint: "Transportda kelmoq → прие́хал.",
        },
        {
          t: "fill",
          q: "To'ldiring: «Она́ ___ на рабо́ту.» (уйти́, o'tgan zamon, ayol)",
          answer: ["ушла", "ушла́"],
          hint: "уйти́ → ушёл / ушла́ / ушли́.",
        },
        {
          t: "match",
          q: "Prefiksni predlogga ulang",
          pairs: [
            ["в-ходи́ть", "в ко́мнату"],
            ["вы-ходи́ть", "из ко́мнаты"],
            ["под-ходи́ть", "к окну́"],
            ["от-ходи́ть", "от окна́"],
            ["до-ходи́ть", "до угла́"],
          ],
